$(document).ready(function() {
  ...
  var gameState = {
    ...
    updateGame: function() {
      alert("updateGame not implemented");
    },
    updateInfo: function() {
      alert("updateInfo not implemented");
    },
    userWin: function() {
      alert("userWin not implemented");
    },
    userLost: function() {
      alert("userLost not implemented");
    },
    letterUsed: function() {
      alert("letterUsed not implemented");
    },
    applyLetter: function() {
      alert("applyLetter not implemented");
    },
    processInput: function() {
      alert("processInput not implemented");
    }
  };
  ...
  gameState.letterUsed = function(letter) {
    for (var i = 0; i < this.wrongLetters.length; i++) {
      if (letter === this.wrongLetters[i]) {
        alert(
          "You've already used this letter, try another one or I'll keep bothering you!"
        );
        return true;
      }
    }
